...
function baseInput(
  ...
  return {
    ...
    timeoutMs: 10_000,
    dependencies: {
      packageContext: packageOk as SellerTurnRuntimeDependencies['packageContext'],
      buildEmergencyContinuationCapsule: capsuleOk as SellerTurnRuntimeDependencies['buildEmergencyContinuationCapsule'],
      ...
      validateSellerSubmission: validateSubmission as SellerTurnRuntimeDependencies['validateSellerSubmission'],
